...
For general security questions, file a GitHub issue. For roadmap context, see the
[repository roadmap](https://github.com/git-stunts/git-cas/blob/main/ROADMAP.md).
