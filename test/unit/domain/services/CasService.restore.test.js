...
describe('CasService.restore()', () => {
  let service;
  let crypto;
  let mockPersistence;
  /** Map<oid, Buffer> simulating Git ODB */
  let blobStore;
  ...
  // ---------------------------------------------------------------------------
  // Helper: store content via async iterable, return manifest
  // ---------------------------------------------------------------------------
