# TR-005 — CasService Decomposition Plan
...
appears to hold multiple responsibilities under one roof:
chunking orchestration, manifest generation, encryption flow, and vault-facing
behavior.
