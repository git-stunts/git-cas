...
workspace descriptors, refs, readers, or existing workspace methods.
...
containment checks, and checked ref updates fell from one per wave to one per
compound admission. The semantic handle digests matched exactly.
...
See the [machine witness](../design/0060-compound-workspace-admission/witness/compound-workspace-admission.json)
and [verification narrative](../design/0060-compound-workspace-admission/witness/verification.md)
