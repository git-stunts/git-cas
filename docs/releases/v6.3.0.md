...
preflight symbolic refs before no-dereference updates.
...
6,295 tests across Node, Bun, and Deno. Its npm dry run contained 242 files
(745,751 bytes packed; 2,049,456 bytes unpacked). CI, self-review, Code Rabbit,
